...
{
    //[ApiController]
    public abstract class AccumulationRegisterController : ControllerBase
    {
        protected IAccumulationRegisterService? _service;
        ...
        public async Task<ActionResult<ServiceResult>> GetODataAndDbCountAsync(DateTime begin, DateTime end)
        {
            ...
            if (begin == DateTime.MinValue || end == DateTime.MinValue || end < begin)
                return BadRequest();
