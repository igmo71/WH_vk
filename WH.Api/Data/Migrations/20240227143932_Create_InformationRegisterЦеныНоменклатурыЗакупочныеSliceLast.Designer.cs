...
namespace WH.Api.Data.Migrations
{
    ...
    [Migration("20240227143932_Create_InformationRegisterЦеныНоменклатурыЗакупочныеSliceLast")]
    partial class Create_InformationRegisterЦеныНоменклатурыЗакупочныеSliceLast
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WH.Domain.Models.AccumulationRegister.AccumulationRegisterСебестоимостьТоваровBalance", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<double>("КоличествоBalance")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("СтоимостьBalance")
                        .HasColumnType("float");

                    b.HasKey("Id");

                    b.ToTable("AccumulationRegister_СебестоимостьТоваров_Balance", (string)null);
                });

            modelBuilder.Entity("WH.Domain.Models.AccumulationRegister.AccumulationRegisterСебестоимостьТоваровBalanceAndTurnovers", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.Property<double>("СтоимостьClosingBalance")
                        .HasColumnType("float");

                    b.Property<double>("СтоимостьExpense")
                        .HasColumnType("float");

                    b.Property<double>("СтоимостьOpeningBalance")
                        .HasColumnType("float");

                    b.Property<double>("СтоимостьReceipt")
                        .HasColumnType("float");

                    b.Property<double>("СтоимостьTurnover")
                        .HasColumnType("float");

                    b.HasKey("Id");

                    b.ToTable("AccumulationRegister_СебестоимостьТоваров_BalanceAndTurnovers", (string)null);
                });

            modelBuilder.Entity("WH.Domain.Models.AccumulationRegister.AccumulationRegisterСебестоимостьТоваровRecordType", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.Property<string>("АналитикаАктивовПассивов")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<string>("АналитикаАктивовПассивов_Type")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("АналитикаДоходов")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<string>("АналитикаДоходов_Type")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("АналитикаРасходов")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<string>("АналитикаРасходов_Type")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<string>("ГруппаПродукции_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.Property<string>("ДокументИсточник")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<string>("ДокументИсточник_Type")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<DateTime>("ПериодПродажи")
                        .HasColumnType("Date");
                    ...
                    b.Property<string>("СтатьяАктивовПассивов_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<string>("СтатьяДоходов_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<string>("СтатьяРасходовСписания_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.ToTable("AccumulationRegister_СебестоимостьТоваров_RecordType", (string)null);
                });
