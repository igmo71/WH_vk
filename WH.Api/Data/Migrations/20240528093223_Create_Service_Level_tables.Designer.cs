...
namespace WH.Api.Data.Migrations
{
    ...
    [Migration("20240528093223_Create_Service_Level_tables")]
    partial class Create_Service_Level_tables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WH.Domain.Models.Whs.WhsOrder", b =>
                {
                    ...
                    b.Property<string>("ЗаданиеДляКладовщика")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.ToTable("WhsOrders", (string)null);
                });

            modelBuilder.Entity("WH.Domain.Models.Whs.WhsProductData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WhsProductData", (string)null);
                });
            ...
            modelBuilder.Entity("WH.Domain.Models.Whs.WhsProductData", b =>
                {
                    b.HasOne("WH.Domain.Models.Whs.WhsOrder", null)
                        .WithMany("WhsProductData")
