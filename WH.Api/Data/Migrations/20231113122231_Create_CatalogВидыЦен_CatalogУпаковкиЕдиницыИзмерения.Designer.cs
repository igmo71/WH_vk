...
namespace WH.Api.Data.Migrations
{
    ...
    [Migration("20231113122231_Create_CatalogВидыЦен_CatalogУпаковкиЕдиницыИзмерения")]
    partial class Create_CatalogВидыЦен_CatalogУпаковкиЕдиницыИзмерения
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WH.Domain.Models.Catalog.CatalogВидыЦен", b =>
                {
                    ...
                    b.Property<string>("РеквизитДопУпорядочивания")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
