...
namespace WH.Api.Data.Migrations
{
    ...
    [Migration("20240902144958_Create_ТоварыНаСкладахRecordTypeОперацияЦены")]
    partial class Create_ТоварыНаСкладахRecordTypeОперацияЦены
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WH.Domain.Models.Awesome.VТоварыНаСкладахBalanceAndTurnoversBalanceNoWarehouse", b =>
                {
                    b.Property<DateTime>("Date")
                        .HasColumnType("datetime2");
                    ...
                    b.ToView("v_ТоварыНаСкладах_BalanceAndTurnovers_Balance_no_warehouse", (string)null);
                });

            modelBuilder.Entity("WH.Domain.Models.Awesome.VТоварыНаСкладахRecordTypeОперацияЦены", b =>
                {
                    b.Property<DateTime>("Date")
                        .HasColumnType("Date");
                    ...
                    b.ToView("v_ТоварыНаСкладах_RecordType_Операция_Цены", (string)null);
                });

            modelBuilder.Entity("WH.Domain.Models.Awesome.ТоварыНаСкладахRecordTypeОперацияЦены", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
            ...
            modelBuilder.Entity("WH.Domain.Models.Wms.AccumulationRegisterТоварыВЯчейкахBalanceAndTurnovers", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.Property<double>("КоличествоClosingBalance")
                        .HasColumnType("float");

                    b.Property<double>("КоличествоExpense")
                        .HasColumnType("float");

                    b.Property<double>("КоличествоOpeningBalance")
                        .HasColumnType("float");

                    b.Property<double>("КоличествоReceipt")
                        .HasColumnType("float");

                    b.Property<double>("КоличествоTurnover")
                        .HasColumnType("float");
                    ...
                    b.Property<string>("Ячейка_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.HasKey("Id");

                    b.ToTable("wms_AccumulationRegister_ТоварыВЯчейках_BalanceAndTurnovers", (string)null);
                });

            modelBuilder.Entity("WH.Domain.Models.Wms.CatalogЯчейки", b =>
                {
                    b.Property<string>("Ref_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.Property<string>("ВидЯчейки")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<double?>("ВместимостьПаллет")
                        .HasColumnType("float");

                    b.Property<double?>("Высота")
                        .HasColumnType("float");

                    b.Property<int?>("Глубина")
                        .HasColumnType("int");

                    b.Property<double?>("Длина")
                        .HasColumnType("float");

                    b.Property<double?>("ДопустимаяСтепеньЗаполненности")
                        .HasColumnType("float");

                    b.Property<bool?>("Заблокированна")
                        .HasColumnType("bit");

                    b.Property<string>("ЗонаСклада_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<string>("КлассABC")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<string>("КлассXYZ")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.Property<double?>("Объем")
                        .HasColumnType("float");

                    b.Property<bool?>("ПередаватьРезультатыИнвентаризации")
                        .HasColumnType("bit");

                    b.Property<string>("Покупатель_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<int?>("Полка")
                        .HasColumnType("int");

                    b.Property<int?>("Помещение")
                        .HasColumnType("int");

                    b.Property<string>("Поставщик_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<int?>("ПриоритетВыборки")
                        .HasColumnType("int");

                    b.Property<bool?>("РазмещениеПогрузчиком")
                        .HasColumnType("bit");

                    b.Property<bool?>("Распечатан")
                        .HasColumnType("bit");

                    b.Property<bool?>("Резерв")
                        .HasColumnType("bit");

                    b.Property<int?>("Ряд")
                        .HasColumnType("int");

                    b.Property<string>("СерияТовараВЯчейке_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.Property<DateTime?>("СрокГодностиТовараВЯчейке")
                        .HasColumnType("datetime2");

                    b.Property<int?>("Стойка")
                        .HasColumnType("int");

                    b.Property<bool?>("ТестовыйРежим_МножественноеРазмещение")
                        .HasColumnType("bit");

                    b.Property<string>("ТипХранения")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<string>("ТипЯчейки")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<string>("ТранспортнаяКомпания_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<double?>("Ширина")
                        .HasColumnType("float");

                    b.HasKey("Ref_Key");

                    b.ToTable("wms_Catalog_Ячейки", (string)null);
                });

            modelBuilder.Entity("WH.Domain.Models.Wms.CatalogЯчейкиНоменклатураЯчейки", b =>
                {
                    b.Property<string>("Ref_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.ToTable("wms_Catalog_Ячейки_НоменклатураЯчейки", (string)null);
                });
            ...
            modelBuilder.Entity("WH.Domain.Models.Wms.CatalogЯчейкиНоменклатураЯчейки", b =>
                {
                    b.HasOne("WH.Domain.Models.Wms.CatalogЯчейки", null)
                        .WithMany("НоменклатураЯчейки")
                        .HasForeignKey("Ref_Key")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WH.Domain.Models.Wms.CatalogЯчейки", b =>
                {
                    b.Navigation("НоменклатураЯчейки");
                });
