...
namespace WH.Api.Data.Migrations
{
    ...
    [Migration("20250418123104_CreateIInformationRegisterТэгиПартнеров")]
    partial class CreateIInformationRegisterТэгиПартнеров
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WH.Domain.Models.Catalog.CatalogТэгиПартнеров", b =>
                {
                    b.Property<string>("Ref_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.ToTable("Catalog_ТэгиПартнеров", (string)null);
                });
            ...
            modelBuilder.Entity("WH.Domain.Models.InformationRegister.InformationRegisterТэгиПартнеров", b =>
                {
                    b.Property<string>("Партнер_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<string>("Тэг_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.HasKey("Партнер_Key", "Тэг_Key");

                    b.ToTable("InformationRegister_ТэгиПартнеров", (string)null);
                });
            ...
            modelBuilder.Entity("WH.Domain.Models.Wms.AccumulationRegisterТоварыВЯчейкахBalanceAndTurnovers", b =>
                {
                    ...
                    b.Property<string>("Паллет_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");

                    b.Property<string>("Серия_Key")
                        .HasMaxLength(36)
                        .HasColumnType("nvarchar(36)");
