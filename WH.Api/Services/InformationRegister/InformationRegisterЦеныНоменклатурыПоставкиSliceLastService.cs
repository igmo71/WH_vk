...
{
    public interface IInformationRegisterЦеныНоменклатурыПоставкиSliceLastService : IInformationRegisterPeriodicService
    { }

    public class InformationRegisterЦеныНоменклатурыПоставкиSliceLastService : IInformationRegisterЦеныНоменклатурыПоставкиSliceLastService
    {
        protected readonly IODataClient _oDataClient;
        protected readonly IInformationRegisterЦеныНоменклатурыПоставкиSliceLastParameters _oDataParameters;
        protected readonly IDbContextFactory<AppDbContext> _dbContextFactory;
        protected readonly ILogger<InformationRegisterЦеныНоменклатурыПоставкиSliceLast> _logger;
        protected readonly IConfiguration _configuration;

        private readonly string _entityName = typeof(InformationRegisterЦеныНоменклатурыПоставкиSliceLast).Name;

        public InformationRegisterЦеныНоменклатурыПоставкиSliceLastService(
            IODataClient oDataClient,
            IInformationRegisterЦеныНоменклатурыПоставкиSliceLastParameters oDataParameters,
            IDbContextFactory<AppDbContext> dbContextFactory,
            ILogger<InformationRegisterЦеныНоменклатурыПоставкиSliceLast> logger,
        ...
        public async Task<int> DeleteRangeAsync(DateTime begin, DateTime end)
        {
            ...
            return await dbContext.Set<InformationRegisterЦеныНоменклатурыПоставкиSliceLast>()
        ...
        private async Task<int> LoadingAsync(DateTime date)
        {
            ...
            InformationRegisterЦеныНоменклатурыПоставкиSliceLast[]? values = await GetODataValuesAsync(date);
        ...
        private async Task<InformationRegisterЦеныНоменклатурыПоставкиSliceLast[]?> GetODataValuesAsync(DateTime date)
        {
            string uri = _oDataParameters.GetUri(date);
            var rootobject = await _oDataClient.GetValuesAsync<Rootobject<InformationRegisterЦеныНоменклатурыПоставкиSliceLast>>(uri);
            var values = rootobject?.Values;
            return values;
        }

        private async Task<int> InsertRangeAsync(InformationRegisterЦеныНоменклатурыПоставкиSliceLast[] values)
        {
            using var dbContext = _dbContextFactory.CreateDbContext();
