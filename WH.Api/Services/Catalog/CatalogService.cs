...
{
    public abstract class CatalogService<TEntity> : ICatalogService where TEntity : Entity
    {
        protected readonly IODataClient _oDataClient;
        protected readonly IODataParameters _oDataParameters;
        protected readonly IDbContextFactory<AppDbContext> _dbContextFactory;
        protected readonly ILogger<CatalogService<TEntity>> _logger;
        ...
        public CatalogService(
            ...
            ILogger<CatalogService<TEntity>> logger
            )
        {
